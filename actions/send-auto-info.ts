...
export const submitAutoInfo = async ({ userName, userEmail, userPhone = "", make, model, registrationDate, series, chosenOptions, mileage, displacement, body, isSwiss, doors, additionalInfo, useOther }) => {
	...
	if (useOther) {
		try {
			await resend.emails.send({
				...
				to: 'ncmosleey@gmail.com',
				subject: 'New User Sent other info',
				html: `
