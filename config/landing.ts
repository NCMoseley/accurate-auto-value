...
export const testimonials: TestimonialType[] = [
  ...
  },
  {
    ...
    review:
      "I was amazed at how easy it was to sell my car using this platform! The process was streamlined and user-friendly, from listing my vehicle to finalizing the sale. The integrated payment system made the transaction secure and hassle-free. I highly recommend this service to anyone looking to sell their car quickly and efficiently.",
  },
  {
    name: "David Smith",
    job: "DevOps Engineer",
